...
class TaxonomyManagerForm extends FormBase {
  ...
  /**
   * AJAX callback handler for search terms from a given vocabulary.
   */
  public function searchFormCallback($form, FormStateInterface $form_state) {
    return $this->modalHelper($form_state, 'Drupal\taxonomy_manager\Form\SearchTermsForm', 'taxonomy_manager.admin_vocabulary.search', $this->t('Search'));
  }
